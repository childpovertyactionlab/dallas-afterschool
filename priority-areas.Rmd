...
## Typology of Afterschool Program Access

To assess which census tracts have the highest demand compared to supply, each score was classified into one of five initial groups based on the identified score ranging from very low to very high.

**Total Census Tracts by Classification Group**
...
The group classification for the demand and supply scores were then compared against one another in order to determine a census tract's general typology.

## Primary Typologies

By comparing the distance between the supply and demand score group against one another we were able to identify three primary typologies within Dallas County:
...
In order to drive strategy, the group of census tracts identified in the 'Demand Exceeds Supply' typology were refined into communities that are of a higher priority for additional afterschool programming.

Any census tract that belonged to the 'Demand Exceeds Supply' group and contained the following characteristics is identified as a priority area.

* A gap of at least 2 between supply and demand groups.
...
With these additional criteria 44 census tracts across Dallas County were identified as high priority where additional afterschool programming contains the opportunity to have an outsized effect on these communities.

Based on our analysis these priority areas currently do not have any afterschool programming within them despite containing an estimated 38,400 eligible children.

By contrast, there are 35 census tracts across Dallas County identified as having the highest supply relative to current demand have an estimated 13,391 children eligible for afterschool programming, with 84 total programs across them. 

This disparity emphasizes the need for more equitably distributed afterschool programming in the areas of highest need for children in Dallas County. 