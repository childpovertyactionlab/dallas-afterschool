...
In order to understand the landscape of afterschool programs across Dallas County we broke the problem down into two components. The existing afterschool environment and current neighborhood conditions. Comparing each component against one another will allow us to estimate where the greatest need for additional afterschool programming is across the county.
