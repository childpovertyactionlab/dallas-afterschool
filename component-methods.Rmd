...
```{r, Families Below Poverty, echo = FALSE, message=FALSE, warning=FALSE, layout="l-body", fig.height=8}
# Generate Jenks Breaks for plot
...
```{r, Single Mother Households, echo = FALSE, message=FALSE, warning=FALSE, layout="l-body", fig.height=8}
# Generate Jenks Breaks for plot
